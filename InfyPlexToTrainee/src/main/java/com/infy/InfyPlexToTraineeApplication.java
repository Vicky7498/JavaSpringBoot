...
public class InfyPlexToTraineeApplication implements CommandLineRunner {

    private static final Logger LOGGER = LogManager.getLogger(InfyPlexToTraineeApplication.class);
    @Autowired
    ...
    public static void main(String[] args) {
        SpringApplication.run(InfyPlexToTraineeApplication.class, args);
    }
    ...
    public void getNumberOfMoviesReleased() {
        ...
        try {
            ...
            LOGGER.info(environment.getProperty("UserInterface.MOVIE_YEAR_BETWEEN") + fromYear + " and " + toYear + " = " + noOfMoviesReleased);
            LOGGER.info("\n");
        } catch (Exception e) {
            LOGGER.info(environment.getProperty(e.getMessage(), "Some exception occured.Please check log file."));
        }
